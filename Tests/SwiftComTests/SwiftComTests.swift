import XCTest
import SwiftUI
@testable import SwiftCom

final class SwiftComTests: XCTestCase {
    ...
    func testFarApartReadings() throws {
        ...
        let readings = [
            GlucoseReading(value: 100, trend: .flat, timestamp: baseDate),
            GlucoseReading(value: 112, trend: .flat, timestamp: baseDate.advanced(by: -1.0 * GGOptions.shared.readingOldnessInterval))
        ]
        let encoder = JSONEncoder()
